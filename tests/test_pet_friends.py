...
def test_get_api_key_for_valid_user(email=valid_email, password=valid_password):
    ...
    assert status == 200
    assert result['key'] == '35978c5eccaa1e2fb14e1bb1fd646bdc28ed0498e31a1a863a7ef853'
...
def test_post_api_pets_with_valid_data(name='Кеша', animal_type='попугай', age='3',
                                       pet_photo='images\попугай_Кеша.jpg'):
...
def test_post_api_pets_with_invalid_photo(name='Гоша', animal_type='попугай', age='-1',
...
def test_delete_api_pets_pet_id():
    ...
    if len(my_pets['pets']) == 0:
        status, _ = pf.post_api_create_pet_simple(auth_key, "Леопольд", "кот", "10")
...
def test_successful_update_self_pet_info(name='Бобик', animal_type='собака', age='7'):
...
# API должна возвращать 400, а она возвращает 200
def test_update_self_pet_invalid_age(name='Бобик', animal_type='собака', age=-100):
...
def test_post_api_create_pet_simple_with_valid_data(name='Кеша', animal_type='попугай', age='3'):
    """Проверяем что можно добавить питомца с корректными данными"""
    _, auth_key = pf.get_api_key(valid_email, valid_password)
    # Добавляем питомца
...
# API должна возвращать 400, а она возвращает 200
def test_post_api_create_pet_simple_with_invalid_age(name='Гоша', animal_type='попугай', age='age'):
    """Проверяем что можно добавить питомца с некорректными данными"""
    _, auth_key = pf.get_api_key(valid_email, valid_password)
    # Добавляем питомца
    status, result = pf.post_api_create_pet_simple(auth_key, name, animal_type, age)
